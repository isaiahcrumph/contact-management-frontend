...
{/* Search Bar Area */}
<div className="relative w-64"> {/* Container for the search bar, width set to 64 (adjustable) */}
  ...
  <input 
    ...
    className="w-full bg-gray-700 text-white rounded-md px-3 py-2 pr-10 focus:outline-none"
  />
...
<div className="flex justify-center mb-6">
  <div className="w-full">
    ...
    <div className={`flex justify-end ${currentUser?.role === 'Admin' ? 'mt-4' : ''}`}>
      <button
        onClick={handleRead}
